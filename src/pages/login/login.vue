...
<script>
  import userLogin from "@components/page/login/userlogin";
  import codeLogin from "@components/page/login/codelogin";
  import thirdLogin from "@components/page/login/thirdlogin";
